...
S = {
    ...
    "app_subtitle":     ("Wärmepumpe · Echtzeit", "Heat pump · real-time"),
    "settings":         ("Einstellungen", "Settings"),
    "group_live":       ("Live · jetzt", "Live · now"),
    "group_components": ("Komponenten", "Components"),
    "group_analysis":   ("Analyse", "Analysis"),
    "updated_every":    ("aktualisiert alle {s} s", "refreshes every {s} s"),
    "every":            ("alle {s} s", "every {s} s"),
    ...
    "pill_active":        ("Aktiv", "Active"),
    "pill_paused":        ("Pause", "Paused"),
    "pill_manual":        ("Manuell", "Manual"),
    "pill_idle":          ("Inaktiv", "Idle"),
    ...
    "estimated_tip":    ("Geschätzt aus WP-Laufzeit × Nennleistung (in den Einstellungen) — der Shelly misst die WP-Leistung nicht.",
                         "Estimated from HP runtime × nominal power (see settings) — the Shelly doesn't meter HP power."),
    "today_lc":         ("heute", "today"),
    ...
    "supply":       ("Vorlauf", "Flow"),
    "cop_today":    ("COP heute", "COP today"),
    "cop_tip":      ("Heute erzeugte Wärme ÷ verbrauchter Strom (ViCare)",
                     "Heat produced today ÷ electricity consumed (ViCare)"),
    ...
    "energy_today": ("Energie heute:", "Energy today:"),
    "elec":         ("el.", "elec."),
    "thermal":      ("therm.", "thermal"),
    "heating_sh":   ("Heiz", "heat"),
    "dhw_sh":       ("WW", "DHW"),
    "el_pending":   ("el. noch nicht gemeldet", "electrical not reported yet"),
    ...
    "energy_asof":  ("Energie-Stand", "Energy as of"),
    "energy_lag_tip": ("ViCare aktualisiert die Energie-Zähler verzögert; Temperaturen & Effizienz sind live.",
                       "ViCare updates the energy counters with a delay; temperatures & efficiency are live."),
    ...
    "inv_note":        ("Ost = MPPT-Eingang A (Morgen-Peak), West = MPPT-Eingang B (Nachmittags-Peak) — getrennte DC-Stränge.",
                        "East = MPPT input A (morning peak), West = MPPT input B (afternoon peak) — separate DC strings."),
    ...
    "cloud_cover":        ("Bewölkung", "cloud cover"),
    ...
    "sec_balance":      ("Heute & Wirksamkeit", "Today & effectiveness"),
    "sec_vicare":       ("Wärmepumpe · ViCare", "Heat pump · ViCare"),
    "sec_inverter":     ("Wechselrichter · SMA", "Inverter · SMA"),
    "sec_today_chart":  ("Heute · Überschuss, Schwelle & WP-Lauf", "Today · surplus, threshold & HP run"),
    "sec_eff":          ("Wirksamkeit", "Effectiveness"),
    "sec_history":      ("WP-Historie", "HP history"),
    "hist_sub":         ("Temps · Lauf · Verdichter · Effizienz", "Temps · run · compressor · efficiency"),
